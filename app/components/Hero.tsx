        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              As a Software Engineer Associate, I develop and implement efficient software solutions, collaborating with
              cross-functional teams to deliver high-quality applications while continuously enhancing my technical
              skills
            </p>
            <div className="flex justify-center lg:justify-start space-x-4 mb-8">
              <a
                href="https://github.com/NtlekoAmahle1"
              ...
              <a
                href="https://www.linkedin.com/in/amahle-ntleko-015154255"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
              ...
              <a
                href="mailto:ntleko.amahle1@gmail.com"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
          ...
          >
            <div className="relative w-[280px] h-[350px] md:w-[320px] md:h-[400px] mx-auto">
              ...
              <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Amah-6xL3C21h42Q9Ttg3l6YQG0Fw58BBFH.jpeg"
                  alt="Amahle Ntleko"
                  fill
